...
var settOrderWebphoneWebRTCFlash = 'serveraddress_user,sipusername,password,submenu_sipsettings,submenu_media,submenu_calldivert,submenu_general,theme,language,accounts,email,incomingcallpopup,sendchatonenter,proxyaddress,realm,username,displayname,hidemyidentity,usetunneling,ringtimeout,calltimeout,dtmfmode,chatsms,earlymedia,defmute,customsipheader,normalizenumber,techprefix,filters,voicemailnum,callbacknumber,callforwardonbusy,callforwardonnoanswer,callforwardalways,calltransferalways,transfwithreplace,autoignore,autoaccept,blacklist,dialerintegration,integrateifwifionly,nativefilterallow,nativefilterblock,audiodevices,displayvolumecontrols,displayaudiodevice,savetocontacts,telsearchkey,extraoption,reset_settings,loglevel,loglevel_dbg,codec,'+
        'audio_bandwidth,video,video_bandwidth,video_width,video_height,'+
        'cfgvideo,video_profile,videocodec,'+ aspeak +
//        'submenu_screenshare,sscontrol,ssscroll,sstop,ssquality,'+
...
var settOrderWin = 'serveraddress_user,sipusername,password,submenu_sipsettings,submenu_media,submenu_calldivert,submenu_general,theme,language,accounts,email,sendchatonenter,proxyaddress,realm,username,displayname,flash,beeponincoming,importonlywithnum,hidemyidentity,usetunneling,transport,use_fast_ice,use_stun,use_rport,register,registerinterval,keepaliveival,keepalive,natopenpackets,ringtimeout,calltimeout,dtmfmode,chatsms,prack,earlymedia,sendrtponmuted,defmute,changesptoring,localip,signalingport,rtpport,capabilityrequest,customsipheader,normalizenumber,techprefix,filters,callforwardonbusy,callforwardonnoanswer,callforwardalways,calltransferalways,transfwithreplace,autoignore,autoaccept,rejectonvoipbusy,voicemailnum,callbacknumber,blacklist,transfertype,automute,autohold,startwithos,dialerintegration,integrateifwifionly,nativefilterallow,nativefilterblock,audiodevices,displayvolumecontrols,displayaudiodevice,savetocontacts,telsearchkey,extraoption,reset_settings,loglevel,loglevel_dbg,playring,'
        +'video,video_bandwidth,video_width,video_height,'
        +'cfgvideo,videomode,video_profile,videocodec,'+
        'submenu_screenshare,sscontrol,ssscroll,sstop,ssquality,'+
        'video_fps,codec,setfinalcodec,aec,denoise,agc,plc,silencesupress,hardwaremedia,volumein,volumeout,mediaencryption,setqos,codecframecount,doublesendrtp,jittersize,audiobufferlength,speakermode';
